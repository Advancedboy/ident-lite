...
import com.identlite.api.service.LogGenerationService;
...
public class LogController {
    ...
    @Operation(summary = "Получить лог файл по дате", description = "возвращает .log файл, сформированный в указанный день (формат yyyy-MM-dd)")
    @GetMapping("/{date}")
    public ResponseEntity<InputStreamResource> getLogsByDate(
        ...
        try {
            ...
            String fileName = "logs/app-" + localDate.format(DATE_FORMATTER) + ".log";
